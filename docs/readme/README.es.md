...
![Demostración de World Map Timezone Map Wallpaper](../../assets/world-map-timezone-map-preview.gif)
...
Usando Mumbai como ejemplo, especifica la zona horaria, el nombre y las coordenadas:
