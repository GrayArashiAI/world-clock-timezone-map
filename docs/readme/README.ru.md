...
Добавляемые вручную часовые пояса должны присутствовать в [списке городов IANA](https://data.iana.org/time-zones/tzdb-2026b/zone.tab). В проекте используется версия IANA 2026b.
