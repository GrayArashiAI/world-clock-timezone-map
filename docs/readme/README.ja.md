...
IANAの都市一覧は、手動で入力するタイムゾーンを選ぶためのものです。表示したい都市がこの一覧に載っている必要はありません。個別の IANA 項目がない場合は、同じタイムゾーンの IANA 都市を選んでください。本プロジェクトで使用している IANA のバージョンは 2026c です。

IANAの都市一覧：[IANAの都市一覧](https://data.iana.org/time-zones/tzdb-2026c/zone.tab)
